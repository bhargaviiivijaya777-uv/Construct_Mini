...
.whatsapp-cell{color:#25d366;font-weight:600;}
...
<header class="topbar">
    ...
    <nav class="mainnav">
        ...
        <a href="add_seller.php" style="background:rgba(16,185,129,0.2);border-color:rgba(16,185,129,0.4);"><i class="fas fa-plus"></i> Add Seller</a>
    </nav>
</header>

<main class="container">
    <h1><i class="fas fa-users"></i> Sellers List</h1>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><strong><?php echo htmlspecialchars($r['seller_name']); ?></strong></td>
                    <td><?php echo htmlspecialchars($r['contact_number']); ?></td>
                    <td class="whatsapp-cell">
                        <?php if(!empty($r['whatsapp_number'])): ?>
                            <i class="fab fa-whatsapp"></i> <?php echo htmlspecialchars($r['whatsapp_number']); ?>
                        <?php else: ?>
                    ...
                    <td>
                        <div class="actions">
                            <a href="edit_seller.php?id=<?php echo $r['seller_id']; ?>" class="btn btn-edit">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <a href="delete_seller.php?id=<?php echo $r['seller_id']; ?>" class="btn btn-delete" onclick="return confirm('Delete this seller?')">
